# Portfolio agents — Apex

Every prompt in this repo is handled by **Apex** (see `.cursor/rules/apex.mdc` and `.cursor/agents/orchestrator.md`).
...
- Hire on gap: `.cursor/agents/hire.md` (Blake)
- Content skills (when Iris routes): `syra-text-post`, `video-shotcraft`, `video-use`
